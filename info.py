...
BOT_TOKEN = environ.get('BOT_TOKEN', "6661533788:AAFfTltv5kXV0jsyrG7iZbp4c-WALGSU26o")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002050794221').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002050794221')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://KGF:KGF@cluster0.dxwqpva.mongodb.net/?retryWrites=true&w=majority")
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/hdlinks4uu')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello 😤')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002050794221'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002050794221')).split()]
...
URL = "https://ybwinl.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://ybwinl.onrender.com".format(FQDN, PORT)
