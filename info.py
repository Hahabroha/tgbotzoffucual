...
PICS = (environ.get('PICS', 'https://telegra.ph/file/ed8ce5e09c867b231f58a.jpg')).split()
...
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/3dbd4435b7578387ed7a8.jpg")
...
MSG_ALRT = environ.get('MSG_ALRT', 'BHUPENDRA JOGI 🤡')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002050794221'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1001785617521')
